...
import { CallToolRequestSchema, ListToolsRequestSchema, ToolSchema, ReadResourceRequestSchema } from '@modelcontextprotocol/sdk/types.js';
...
const SCREENSHOT_TOOL = {
    ...
    name: "screenshot",
    type: "function",
    inputSchema: zodToJsonSchema(ScreenshotOperationSchema),
};
const TOOLS = [
    SCRAPER_TOOL,
    // SCREENSHOT_TOOL
...
const screenshotWithURL = async (url) => {
...
const scrapeWithPrompt = async (prompt, format, progressToken) => {
    const chat_id = nanoid();
